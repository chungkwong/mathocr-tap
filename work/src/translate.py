...
def gen_sample(models, x, trng=None, k=1, maxlen=30, dictlen=107, 
...
def main(model_files, dictionary_target, data_path, saveto, wer_file, k=5):
...
if __name__ == "__main__":
    ...
    main(args.model, args.dictionary_target, args.data_path,
